...
- **Cross-check:** [Cursor Agent overview](https://cursor.com/docs/agent/overview.md), [Cursor CLI overview](https://cursor.com/docs/cli/overview.md), and [CLI parameters](https://cursor.com/docs/cli/reference/parameters.md)
- **Verified:** 2026-07-22
