...
export function operationalReasonForContractError(code: string): ExecutionReasonCode {
  ...
  const exact: Readonly<Record<string, ExecutionReasonCode>> = {
    ...
    EXECUTION_ARTIFACT_TOO_LARGE: "ARTIFACT_TOO_LARGE",
    EXECUTION_STORAGE_QUOTA_EXCEEDED: "STORAGE_QUOTA_EXCEEDED",
    ...
    EXECUTION_STALE_FENCING_TOKEN: "STALE_FENCING_TOKEN",
    EXECUTION_CONTROLLER_OWNERSHIP_RECONCILIATION_REQUIRED: "CONTROLLER_OWNERSHIP_RECONCILIATION_REQUIRED",
    EXECUTION_PROJECTION_REBUILD_REQUIRED: "PROJECTION_REBUILD_REQUIRED",
    EXECUTION_PENDING_EFFECT_RECONCILIATION_REQUIRED: "PENDING_EFFECT_RECONCILIATION_REQUIRED",
    EXECUTION_STORAGE_CORRUPT: "STORAGE_CORRUPT",
    EXECUTION_LEGACY_IMPORT_INVALID: "LEGACY_IMPORT_INVALID",
  };
