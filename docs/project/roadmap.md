...
| Controller recommendation MVP | `COMPLETE_WITH_LIMIT` | `src/controller/`, formation catalog, scenario recommendation, and focused tests | Keep the ready Quick Task path stable; complete ready scenario recipes and profile-specific output contracts separately. | `implements` Controller layer |
