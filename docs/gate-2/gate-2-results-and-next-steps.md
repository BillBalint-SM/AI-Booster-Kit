...
Cursor and Claude Code local execution is currently `NOT EXECUTED`: their CLIs were not found in the current environment. The separate [Cursor record](../operations/host-conformance-runs/cursor-2026-07-27.md) and [Claude Code record](../operations/host-conformance-runs/claude-code-2026-07-27.md) preserve this blocker and provide the team-run handoff.
