...
Cursor behavior is recorded as `PARTIAL` in the [Cursor behavior record](../operations/host-conformance-runs/cursor-2026-07-27.md), with its [captured response](../operations/host-conformance-runs/cursor-2026-07-27-behavior-response.md) preserved. Cursor security remains `NOT EVALUATED`. Claude Code WSL behavior is recorded as `FAIL` in the [Claude Code behavior record](../operations/host-conformance-runs/claude-code-2026-07-27.md), with its [captured response](../operations/host-conformance-runs/claude-code-2026-07-28-behavior-response.md) preserved. The untracked project-local permission file remains outside the commit.
