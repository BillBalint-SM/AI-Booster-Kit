...
Archive evidence is immutable historical context, not a default instruction or current-state source.

## Archived evidence

- [Gate 2 historical state and roadmap](gate-2/current-state-and-roadmap.md)
