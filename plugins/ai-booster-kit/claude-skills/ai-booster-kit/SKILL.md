...
3. Recommend exactly one route:
   ...
   - no accepted, implementation-ready plan: `/ai-booster-kit:booster-plan`;
   - material team ownership or independent-review ambiguity:
     `/ai-booster-kit:booster-team-align`;
   - accepted current plan and verified repository: `/ai-booster-kit:booster-implement`;
   - changed result needing reproducible evidence: `/ai-booster-kit:booster-test`;
   - review-ready result with sufficient evidence: `/ai-booster-kit:booster-review`;
   - complete or reviewed result needing continuation context:
     `/ai-booster-kit:booster-handoff`.
