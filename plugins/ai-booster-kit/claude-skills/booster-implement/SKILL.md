...
`/ai-booster-kit:booster-plan` or a new acceptance checkpoint. Never reinterpret a draft or
...
Recommend `/ai-booster-kit:booster-test` for independent validation or `/ai-booster-kit:booster-review` when
